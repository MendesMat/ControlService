...
| Unknown screen in a profile's levels (OQ-11) | The save is refused with a message to reload the page, so a mistyped key never looks saved | [permission profiles](features/permission-profiles.md#validation-on-save) (PERM-24) |
