...
- **Trade-offs, Riscos e Impactos:** Garanto a entrega técnica temporal do projeto (*time-to-market*). O *trade-off* para a empresa é a inclusão de um fornecedor crítico ao fluxo de caixa (*Vendor Lock-in*) e o meu compromisso com a disponibilidade dessa infraestrutura terceira para a concretização operacional (Conascência Dinâmica de serviço externo).
