...
The front-end validates every form before saving (`docs/03-regras-de-negocio.md`), but the back-end cannot trust the client. Validation errors must reach the front-end in a shape it can show next to each field, with the same Portuguese messages.
...
- Error messages are the Portuguese messages already defined in `docs/03-regras-de-negocio.md`.
